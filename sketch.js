...
function gameInstructions() {
    ...
    if (elapsedTime < 3000) { // text disappears after 3 secs
        noStroke();
        fill(0, 0, 139);
        textSize(30);
...
function draw() {
    ...
    drawMountains();
    drawCanyons(); // Draw canyons and check if character fell over the canyon
    drawSun();
    drawClouds();
    drawTrees();
    drawPlatforms();
    ...
    checkEnemiesContact(); // check if character touch the enemy and decrease lives by 1
    checkPlayerPlummeting();
...
function checkPlayerPlummeting() {
...
function drawGameChar() {
    //the game character
    var head_x = gameChar_x;
    var head_y = gameChar_y - 55;
    if (isLeft && isFalling) {
        // jumping-left code
        //*head
        noStroke();
        fill(205, 133, 63);
        ellipse(head_x, head_y, 30);
        //*eyes
        fill(220, 220, 220);
        ellipse(head_x - 8, head_y - 5, 5, 5);
        ellipse(head_x + 8, head_y - 5, 5, 5);
        fill(128, 0, 0);
        ellipse(head_x - 8, head_y - 4, 3, 3);
        ellipse(head_x + 8, head_y - 4, 3, 3);
        //*nose
        fill(139, 0, 0);
        rect(head_x - 2, head_y, 2, 4); // nose at the center of the face
        //*mouth
        fill(178, 34, 34);
        ellipse(head_x - 2, head_y + 10, 6, 6);
        //*hands
        fill(0);
        rect(head_x - 12, head_y + 17, 4, 8);
        rect(head_x + 7, head_y + 17, 4, 8);
        //*body of character
        fill(218, 165, 32);
        rect(head_x - 8, head_y + 15, 15, 30);
        //*feet of character
        fill(0);
        rect(head_x - 5, head_y + 45, 6, 10);
        rect(head_x + 1, head_y + 45, 6, 10);
    }
        ...
        //*eyes
        fill(220, 220, 220);
        ellipse(head_x - 8, head_y - 5, 5);
        ellipse(head_x + 8, head_y - 5, 5);
        fill(128, 0, 0);
        ellipse(head_x - 7.5, head_y - 4, 3, 3);
        ellipse(head_x + 8.5, head_y - 4, 3, 3);
        //*nose
        fill(139, 0, 0);
        rect(head_x + 2, head_y, 2, 4);
        //*mouth
        fill(178, 34, 34);
        ellipse(head_x + 2, head_y + 10, 6, 6);
        //*hands
        ...
        //*body of character
        fill(218, 165, 32);
        rect(head_x - 8, head_y + 17, 15, 30);
        //*feet of character
        fill(0);
        rect(head_x + 1, head_y + 45, 6, 10);
        rect(head_x - 8, head_y + 45, 6, 10);
    }
    else if (isLeft) {
        //walking left code
        //*head
        ...
        //*mouth
        fill(178, 34, 34);
        ellipse(head_x - 2, head_y + 10, 8, 6);
        //*hands
        fill(0);
        rect(head_x - 12, head_y + 20, 4, 8);
        rect(head_x + 7, head_y + 20, 4, 8);
        //*body of character
        fill(218, 165, 32);
        rect(head_x - 8, head_y + 15, 15, 30);
        //*feet of character
        ...
        //nose
        fill(139, 0, 0);
        rect(head_x - 1, head_y - 0, 2, 4);
        //mouth
        fill(178, 34, 34);
        ellipse(head_x, head_y + 10, 10, 2);
        //hands
        fill(0);
        rect(head_x - 12, head_y + 20, 4, 8);
        rect(head_x + 7, head_y + 20, 4, 8);
